...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function describeBackendError(err) {
    ...
    return `Cannot reach backend server.${attempted} Start the backend, then try again. If the backend is on another machine, open Backend Settings and enter its URL.`;
  }
  ...
  async function passwordAuth() {
    ...
    try {
      ...
      setError(friendly || err?.message || "Password login failed.");
    }
  }
